...
class Ingrediente(models.Model):
    ...
    precio_coste_unidad = models.DecimalField(max_digits=10, decimal_places=2, help_text="Coste por KG, Litro o Unidad")
...
class Plato(models.Model):
    ...
    def coste_total(self):
        ...
        # Accedemos a la tabla intermedia PlatoIngrediente
...
class PlatoIngrediente(models.Model):
    """Esta es la 'Receta': une un Plato con un Ingrediente y su cantidad"""
    plato = models.ForeignKey(Plato, on_delete=models.CASCADE, related_name='receta')
    ingrediente = models.ForeignKey(Ingrediente, on_delete=models.CASCADE)
    cantidad = models.DecimalField(max_digits=10, decimal_places=3, help_text="Ej: 0.150 para 150g o 1.000 para una unidad")
